        ...
        >
            ...
            <Wrapper>
                ...
                >
                    ...
                    <div className="hidden md:flex flex items-center gap-[6px]">
                        <div className=" w-[35px] h-[35px] rounded-full bg-[#252525] flex justify-center items-center">
                            <img src={gmailIcon} alt="" className="w-[18px]" />
                        </div>
                        <div>kauxtubx@gmail.com</div>
                    </div>
                    <ul className="flex 2xl:text-[20px]" style={{marginLeft:'0.3cm'}}>
                        <li
                            className=" hidden md:flex cursor-pointer px-5 py-2 hover:bg-slate-900 transition active:scale-90 rounded-lg"
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Kaustubh Dixit</span>
                        
                    </div>
                    <div className="max-w-[510px]">
                    I specialize in building and managing contemporary websites and applications, leveraging expertise in React, HTML, CSS, JS, and Node.js. My work embodies fluid user experiences and features real-world projects with API-integration.
                    </div>
                ...
                >
                    ...
                    <div
                        ...
                        className="absolute top-[230px] -right-[230px] 2xl:top-[240px] 2xl:-right-10 w-[140px] h-[140px] rounded-full bg-white/[0.5] flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => scrollTo("contact")}
                    >
                        <img
                            ...
                            className="w-[15px]"
                        />
                       <div className="text-black" onClick={() => scrollTo("contact")}>Hire Me</div>
                    </div>
                    {/* HIRE ME BUTTON END */}
                </motion.div>
                {/* PERSON BLOCK END */}
